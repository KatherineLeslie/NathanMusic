                                ...
                                <ul id="nav">
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="./single-blog.html">- Achievements</a></li>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInDown" data-delay="900ms">Nathan Schiller</h2>
                                <p data-animation="bounceInDown" data-delay="500ms">Session Player, Collector, Musician</p>
                                <div class="hero-btn-group" data-animation="bounceInDown" data-delay="100ms">
                                    <a href="#" class="btn alime-btn mb-3 mb-sm-0 mr-4">Contact</a>
                                    <a class="hero-mail-contact" href="mailto:nathanschillermusic@gmail.com">nathanschillermusic@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="alime-projects-menu">
                        <div class="portfolio-menu text-center">
                            ...
                            <button class="btn" data-filter=".human">Personal Music</button>
                            <button class="btn" data-filter=".nature">Work with proj 1</button>
                            <button class="btn" data-filter=".country">Work with proj 2</button>
